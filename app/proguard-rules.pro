...
# 实体类
#-keep class com.hotplato.tvbox.bean.** { *; }
#CardView
-keep class com.hotplato.tvbox.ui.tv.widget.card.**{*;}
#ViewObj
-keep class com.hotplato.tvbox.ui.tv.widget.ViewObj{
    <methods>;
}

-keep class com.hotplato.tvbox.crawler.*{*;}
# 迅雷下载模块
-keep class com.xunlei.downloadlib.** {*;}

# XStream XmlPull - avoid R8 conflict with Android framework
...
-keep,allowobfuscation,allowshrinking interface org.xmlpull.v1.XmlPullParser
-keep,allowobfuscation,allowshrinking interface org.xmlpull.v1.XmlSerializer