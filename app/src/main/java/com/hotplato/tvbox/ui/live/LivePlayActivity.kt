package com.hotplato.tvbox.ui.live
...
import com.hotplato.tvbox.ui.activity.LivePlayActivityLegacy
import com.hotplato.tvbox.ui.component.TvFocusButton
import com.hotplato.tvbox.ui.theme.TvTheme

/**
 * Kotlin Compose shell over [LivePlayActivityLegacy] player surface.
 */
class LivePlayActivity : LivePlayActivityLegacy() {
            ...
            setContent {
                TvTheme {
                    ...
                    Row(
                        ...
                        Text("直播控制（Compose）", style = MaterialTheme.typography.titleMedium)
