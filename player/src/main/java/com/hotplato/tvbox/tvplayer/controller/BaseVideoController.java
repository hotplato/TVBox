...
import com.hotplato.tvbox.tvplayer.TvPlayerConfig;
import com.hotplato.tvbox.tvplayer.util.CutoutUtil;
import com.hotplato.tvbox.tvplayer.util.L;
...
public abstract class BaseVideoController extends FrameLayout
    ...
    protected void initView() {
        ...
        mEnableOrientation = TvPlayerConfig.get().mEnableOrientation;
        mAdaptCutout = TvPlayerConfig.get().mAdaptCutout;
    ...
    public boolean showNetWarning() {
        return PlayerUtils.getNetworkType(getContext()) == PlayerUtils.NETWORK_MOBILE
                && !TvPlayerConfig.get().playOnMobileNetwork();
    }
    ...
    protected void onOrientationLandscape(Activity activity) {
        ...
        if (mControlWrapper.isFullScreen()) {
            handlePlayerStateChanged(TvPlayer.PLAYER_FULL_SCREEN);
        } else {
            mControlWrapper.startFullScreen();
        }
    }
    ...
    protected void onPlayerStateChanged(int playerState) {
        switch (playerState) {
            case TvPlayer.PLAYER_NORMAL:
                ...
                break;
            case TvPlayer.PLAYER_FULL_SCREEN:
                //在全屏时强制监听设备方向
                mOrientationHelper.enable();
                if (hasCutout()) {
                ...
                break;
            case TvPlayer.PLAYER_TINY_SCREEN:
                mOrientationHelper.disable();
                break;
        }
    }
